public class Rager_old {
    ...
    public static void rager() {
        ...
        int result = (int) game_story_old.twoDice(6) + game_story_old.character.presence + partyBonus;
        ...
        if (result <= 6) {
            ...
            game_story_old.character.misses += 1;
            kickedOut += 1;
            ...
            game_story_old.character.negForward += 1;
            goodTimes();
        } else if (result >= 10) {
        ...
        if (kickedOut >= 1) {
            ...
            game_shop_old.partiesHad = 0;
            allNighter = 0;
            game_shop_old.party();
        }

        game_shop_old.partiesHad = 1;
        game_shop_old.town();
...
//Party Results
        int partyTime = game_story_old.dice(6);


        switch (partyTime) {
            case 1:
//                Lost an item instead?
                int dam = game_story_old.dice(6);
                game_story_old.character.hp -= dam;
...
////////////
            case 2:
                ...
                int rando = game_story_old.dice(6);
...
////////////
            case 3:
                System.out.println("You wake up in the town gym with sore muscles and vague memories of a workout montage." +
                        "\n you gain...");
                int gains = game_story_old.dice(6);
                int killIt = 1;

                do {
                    if (gains == 1 && game_story_old.character.strength >= 2 ||
                            gains == 2 && game_story_old.character.agility >= 2 ||
                            gains == 3 && game_story_old.character.sharp >= 2 ||
                            gains == 4 && game_story_old.character.presence >= 2) {
                        gains += 1;
                    } else {
                        killIt = 0;
                    }
                ...
                switch (gains) {
                    case 1:
                        game_story_old.character.strength += 1;
                        System.out.println(" +1 to Strength!");
                        break;
                    case 2:
                        game_story_old.character.agility += 1;
                        System.out.println(" +1 to Agility!");

                        break;
                    case 3:
                        game_story_old.character.sharp += 1;
                        System.out.println(" +1 to Sharp!");

                        break;
                    case 4:
                        game_story_old.character.presence += 1;
                        System.out.println(" +1 to Presence!");

                        break;
                    default:
                        game_story_old.character.energy += 1;
...
////////////
            case 4:
                ...
                game_story_old.character.bonusForward += 2;
                break;
////////////
            case 5:
                ...
                int healed = game_story_old.character.maxHP / 2;
                game_story_old.character.hp += healed;
                if (game_story_old.character.hp > game_story_old.character.maxHP) {
                    game_story_old.character.hp = game_story_old.character.maxHP;
                }
...
////////////
            default:
                ...
                int switchOne;
                int switchTwo;
                int switcher = game_story_old.dice(3);
                switch (switcher) {
                    case 1:
                        switchOne = game_story_old.character.strength;
                        switchTwo = game_story_old.character.agility;

                        game_story_old.character.strength = switchTwo;
                        game_story_old.character.agility = switchOne;
                        System.out.println("Your STR and AGI switched!");
                        break;
                    case 2:
                        switchOne = game_story_old.character.strength;
                        switchTwo = game_story_old.character.presence;

                        game_story_old.character.strength = switchTwo;
                        game_story_old.character.presence = switchOne;
                        System.out.println("Your STR and PRE switched!");

                        break;
                    default:
                        switchOne = game_story_old.character.agility;
                        switchTwo = game_story_old.character.presence;

                        game_story_old.character.agility = switchTwo;
                        game_story_old.character.presence = switchOne;
